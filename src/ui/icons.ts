...
const P: Record<string, string> = {
  ...
  crampons: '<path d="M4 10.5h11.5a4 4 0 0 1 4 4V15H4z"/><path d="M5 15l-1 3M9 15l-1 3M13 15l-1 3M17 15l-1 3"/><path d="M7 10.5V7h4"/>',
  ice_axe: '<path d="M13 5l-8 15"/><path d="M8.5 6.5c2.8-1.6 7.5-2.2 11-1-1.9.3-3.7 1.2-5 2.4"/><path d="M8.5 6.5l3.3 1.6"/>',
